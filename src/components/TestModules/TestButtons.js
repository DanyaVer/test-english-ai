...
export default function CreateTestingModule(props) {
  ...
  let buttonsProp = [
    ["Headings", colors[0]],
    ["True/False/Not given", colors[1]],
    ["Match", colors[2]],
    ["Multiple Choice", colors[3]],
  ];
    ...
    <>
      <div className="testButtons">
        <CreateButton
          ...
          isDisabled={props.headingsAreLoading}
        />
        <CreateButton
          prop={modules[1]}
          btnNum={2}
          chosenModule={props.chosenModule}
          setChosenModule={props.setChosenModule}
          isDisabled={props.statementsAreLoading}
        />
      ...
      onClick={() => {
        ...
        if (props.chosenModule !== 0)
          document.getElementById(
            "divTestModule" + props.chosenModule
          ).style.display = "none";
